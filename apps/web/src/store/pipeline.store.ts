          ...
          if (key) {
            set((s) => ({
              deployment: {
                ...s.deployment,
                [key]: true,
                ...(event.zeropsServiceId ? { zeropsServiceId: event.zeropsServiceId } : {}),
              },
            }));
          }
          refreshCache();
      ...
      case "DEPLOYMENT_COMPLETE":
        set((s) => ({
          deployment: {
            ...
            zeropsAppUrl: event.zeropsAppUrl,
            zeropsServiceId: event.zeropsServiceId ?? s.deployment?.zeropsServiceId ?? null,
